  ...
  apps: [
    {
      ...
      script: "/home/clintm/cortextOS/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/home/clintm/cortextOS",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/home/clintm/.cortextos/default",
        CTX_FRAMEWORK_ROOT: "/home/clintm/cortextOS",
        CTX_PROJECT_ROOT: "/home/clintm/cortextOS",
        CTX_ORG: process.env.CTX_ORG || "ElementOneSound",
      },
      max_restarts: 50,
      restart_delay: 5000,
      autorestart: true,
